...
u[:, 0] = data_cleaner.input_signal(0.217, 0.03, time, 0.0, 5)
u[:, 1] = data_cleaner.input_signal(0.5, 0.02, time, 6, 11)
u[:, 2] = data_cleaner.input_signal(0.135, 0.02, time, 12, 17)


# idx_time = time <= 5
# u[:, 0] = 0.03
# u[idx_time, 0] = 0.03 + 0.03 * np.sin(2*np.pi * 0.5 * time[idx_time]**2 /5)

# idx_time = (time >= 6) & (time <= 11)
# u[idx_time, 1] = 0.02 + 0.02 * np.sin(2*np.pi * 0.5 * (time[idx_time] - 6)**2 /5)
# idx_time = time >= 11
# u[idx_time, 1] = 0.02

# idx_time = (time >= 12) & (time <= 17)
# u[idx_time, 2] = 0.02 + 0.02 * np.sin(2*np.pi * 0.5 * (time[idx_time] - 12 )**2 /5)
# idx_time = time >= 17
# u[idx_time, 2] = 0.02

plt.figure()
plt.plot(time, u[:,0], '.', label='PQ_1 Input')
plt.plot(time, u[:,1], '.', label='PQ_2 Input')
plt.plot(time, u[:,2], '.', label='PQ_ Input')
plt.title('Inputs (pu)')
plt.xlabel('Time (s)')
plt.grid(True)
plt.legend()
...
data = np.hstack([time.reshape(-1,1), V_meas])
...
plt.figure()
plt.plot(time, Y[:,0]   , color=[0     , 0.4470, 0.7410], linestyle='-' , label='ANDES Bus 2 Voltage')
plt.plot(time, y_id[:,0], color=[0     , 0.4470, 0.7410], linestyle='--', label='Sys ID Bus 2 Voltage')
plt.plot(time, Y[:,1]   , color=[0.8500, 0.3250, 0.0980], linestyle='-' , label='ANDES Bus 4 Voltage')
plt.plot(time, y_id[:,1], color=[0.8500, 0.3250, 0.0980], linestyle='--', label='Sys ID Bus 4 Voltage')
plt.plot(time, Y[:,2]   , color=[0.9290, 0.6940, 0.1250], linestyle='-' , label='ANDES Bus 7 Voltage')
plt.plot(time, y_id[:,2], color=[0.9290, 0.6940, 0.1250], linestyle='--', label='ANDES Bus 7 Voltage')
plt.plot(time, Y[:,3]   , color=[0.4940, 0.1840, 0.5560], linestyle='-' , label='ANDES Bus 9 Voltage')
plt.plot(time, y_id[:,3], color=[0.4940, 0.1840, 0.5560], linestyle='--', label='ANDES Bus 9 Voltage')
